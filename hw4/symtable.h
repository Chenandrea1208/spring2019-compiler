...
//
int searchTable_wheninsert(struct SymTable*,char*);
struct SymTableNode* searchTable_Whenrefer(struct SymTable*,char*);
int searchTable_Whenasign(struct SymTable*,struct SymTableNode*);
void insert_expresslist(struct Express*,struct ExpressList*);
void parameter_check(struct ExpressList* ,struct SymTableNode*);